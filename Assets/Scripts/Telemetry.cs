...
public class Telemetry : MonoBehaviour
{
    ...
    // Form link
    private const string GoogleFormBaseUrl = "https://docs.google.com/forms/d/e/1FAIpQLSe9jmT-D4S8khV2qWGWd8tkLUBQ3BTaDKCMHx_RLz6iLCNtFg/viewform?usp=sf_link";
    ...
    private const string _gform_player_actions = "entry.1824940384";
    private const string _gform_opponent_actions = "entry.1783260291";
    ...
    public static IEnumerator SubmitGoogleForm(LevelData lvlData)
    {
        ...
        form.AddField(_gform_player_actions, lvlData.playerAction);
        form.AddField(_gform_opponent_actions, lvlData.opponentAction);
